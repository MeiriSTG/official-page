// get header and header-narrow.
const header = document.getElementById("header");
const header_narrow = document.getElementById("header-narrow");
...
header_narrow.onanimationend = () => is_animating = false;
...
window.onscroll = () => {
    ...
    if (scroll < 200) {
        ...
        header_narrow.style.animation = "black-to-white 0.1s linear forwards";
        current_color = WHITE;
    } else {
        if (current_color === BLACK)
            return;
        header.style.animation = "white-to-black 0.1s linear forwards";
        header_narrow.style.animation = "white-to-black 0.1s linear forwards";
        current_color = BLACK;
    }
    is_animating = true;
};